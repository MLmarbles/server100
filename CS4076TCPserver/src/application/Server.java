				    ...
				    if (classParts.length == 4) { // Ensure that all parts are present
				        ...
				        if (moduleToAddClass != null) {
				            if (!isTimeClash(moduleToAddClass, day, start, end)) {
				                // No clash, proceed with adding the class
				        ...
				        out.println("Error: Invalid class information format. Please provide information in the format: day, start time, end time, room.");
				    }
				    break;
